...
Welcome to Bytes, a full-stack blogging web application. This README provides a comprehensive guide to understanding and contributing to the project. The app is deployed and can be accessed at [Bytes](https://bytes-yoku.vercel.app/).
...
- Backend - `Express.js` `MongoDB` `Prisma` `Zod` `JWT` `Typescript` `Render`
...
📬 Thank you for checking out Bytes! If you have any questions or feedback, feel free to open an issue or contact me at harshsaraswat09@gmail.com
